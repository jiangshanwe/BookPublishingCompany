...
/**
 * Gdlg entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gdlg", catalog = "langwen")
public class Gdlg implements java.io.Serializable {
	...
	/** minimal constructor */
	public Gdlg(String shuming, String zuozhe, String chubanshe, String isbn) {
	...
	/** full constructor */
	public Gdlg(String fenlei, String fenlei2, String shuming, String zuozhe,
	...
	public Gdlg(Integer id, String shuming, String tianjiaren,
	...
	public Gdlg(Integer id, String fenlei, String fenlei2, String shuming,
	...
	public String toString() {
		return "Gdlg [id=" + id + ", shuming=" + shuming + ", zuozhe=" + zuozhe
