...
/**
 * Zsgzjy entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zsgzjy", catalog = "langwen")
public class Zsgzjy implements java.io.Serializable {
	...
	/** full constructor */
	public Zsgzjy(String shuming, String chubanshe, String tupian,
