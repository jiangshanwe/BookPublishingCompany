...
/**
 * Zzjy entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zzjy", catalog = "langwen")
public class Zzjy implements java.io.Serializable {
	...
	/** minimal constructor */
	public Zzjy(String shuming, String zuozhe, String chubanshe, String isbn) {
	...
	/** full constructor */
	public Zzjy(String fenlei, String fenlei2, String shuming, String zuozhe,
	...
	public Zzjy(Integer id, String shuming, String tianjiaren,
	...
	public Zzjy(Integer id, String fenlei, String fenlei2, String shuming,
	...
	public String toString() {
		return "Zzjy [id=" + id + ", shuming=" + shuming + ", zuozhe=" + zuozhe
