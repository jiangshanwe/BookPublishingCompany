 ...
 */
@Entity
@Table(name = "hydt", catalog = "langwen")
public class Hydt implements java.io.Serializable {
	...
	/** full constructor */
	public Hydt(String biaoti, String zhengwen, String tianjiaren,
	...
	public Hydt(Integer id, String biaoti, String tianjiaren,
			String tianjiashijian, String ywlj, String gengxinren,
			String gengxinshijian, Integer leixing, Integer paixu) {
		super();
		this.id = id;
