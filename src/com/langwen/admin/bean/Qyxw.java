...
/**
 * Qyxw entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "qyxw", catalog = "langwen")
public class Qyxw implements java.io.Serializable {
	...
	/** full constructor */
	public Qyxw(String biaoti, String zhengwen, String tianjiaren,
	...
	public Qyxw(Integer id, String biaoti, String tianjiaren,
			String tianjiashijian, String ywlj, String gengxinren,
			String gengxinshijian, Integer leixing, Integer paixu) {
		super();
		this.id = id;
