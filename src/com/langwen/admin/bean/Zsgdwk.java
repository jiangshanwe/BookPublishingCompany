...
/**
 * Zsgdwk entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zsgdwk", catalog = "langwen")
public class Zsgdwk implements java.io.Serializable {
	...
	/** full constructor */
	public Zsgdwk(String shuming, String chubanshe, String tupian,
