...
/**
 * Zsjsjy entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zsjsjy", catalog = "langwen")
public class Zsjsjy implements java.io.Serializable {
	...
	/** full constructor */
	public Zsjsjy(String shuming, String chubanshe, String tupian,
