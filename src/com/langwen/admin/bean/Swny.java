...
/**
 * Swny entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "swny", catalog = "langwen")
public class Swny implements java.io.Serializable {
	...
	/** minimal constructor */
	public Swny(String shuming, String zuozhe, String chubanshe, String isbn) {
	...
	/** full constructor */
	public Swny(String fenlei, String fenlei2, String shuming, String zuozhe,
	...
	public Swny(Integer id, String shuming, String tianjiaren,
	...
	public Swny(Integer id, String fenlei, String fenlei2, String shuming,
	...
	public String toString() {
		return "Swny [id=" + id + ", shuming=" + shuming + ", zuozhe=" + zuozhe
