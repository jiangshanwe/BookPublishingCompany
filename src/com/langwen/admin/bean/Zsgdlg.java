...
/**
 * Zsgdlg entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zsgdlg", catalog = "langwen")
public class Zsgdlg implements java.io.Serializable {
	...
	/** full constructor */
	public Zsgdlg(String shuming, String chubanshe, String tupian,
