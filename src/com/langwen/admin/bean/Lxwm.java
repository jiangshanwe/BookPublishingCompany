...
/**
 * Lxwm entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "lxwm", catalog = "langwen")
public class Lxwm implements java.io.Serializable {
	...
	/** minimal constructor */
	public Lxwm(String biaoti, String xiangxi) {
		this.biaoti = biaoti;
		this.xiangxi = xiangxi;
	}

	/** full constructor */
	public Lxwm(String biaoti, String xiangxi, String faburen,
	...
	public Lxwm(Integer id, String biaoti, String faburen, String fabushijian,
	...
	public String toString() {
		return "Lxwm [id=" + id + ", biaoti=" + biaoti + ", xiangxi=" + xiangxi
