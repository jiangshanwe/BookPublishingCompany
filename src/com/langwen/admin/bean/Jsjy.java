 ...
 */
@Entity
@Table(name = "jsjy", catalog = "langwen")
public class Jsjy implements java.io.Serializable {
	...
	/** minimal constructor */
	public Jsjy(String shuming, String zuozhe, String chubanshe, String isbn) {
	...
	/** full constructor */
	public Jsjy(String fenlei, String fenlei2, String shuming, String zuozhe,
	...
	public Jsjy(Integer id, String shuming, String tianjiaren,
	...
	public Jsjy(Integer id, String fenlei, String fenlei2, String shuming,
	...
	public String toString() {
		return "Jsjy [id=" + id + ", shuming=" + shuming + ", zuozhe=" + zuozhe
