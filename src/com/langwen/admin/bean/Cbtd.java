...
/**
 * Cbtd entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "cbtd", catalog = "langwen")
public class Cbtd implements java.io.Serializable {
	...
	/** minimal constructor */
	public Cbtd(String biaoti, String xiangxi) {
		this.biaoti = biaoti;
		this.xiangxi = xiangxi;
	}

	/** full constructor */
	public Cbtd(String biaoti, String xiangxi, String faburen,
	...
	public Cbtd(Integer id, String biaoti, String faburen, String fabushijian,
	...
	public String toString() {
		return "Cbtd [id=" + id + ", biaoti=" + biaoti + ", xiangxi=" + xiangxi
