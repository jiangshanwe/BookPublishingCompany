...
/**
 * Gzjy entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gzjy", catalog = "langwen")
public class Gzjy implements java.io.Serializable {
	...
	/** minimal constructor */
	public Gzjy(String shuming, String zuozhe, String chubanshe, String isbn) {
	...
	/** full constructor */
	public Gzjy(String fenlei, String fenlei2, String shuming, String zuozhe,
	...
	public Gzjy(Integer id, String shuming, String tianjiaren,
	...
	public Gzjy(Integer id, String fenlei, String fenlei2, String shuming,
	...
	public String toString() {
		return "Gzjy [id=" + id + ", shuming=" + shuming + ", zuozhe=" + zuozhe
