...
/**
 * Zszzjy entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zszzjy", catalog = "langwen")
public class Zszzjy implements java.io.Serializable {
	...
	/** full constructor */
	public Zszzjy(String shuming, String chubanshe, String tupian,
