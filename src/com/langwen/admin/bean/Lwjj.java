...
/**
 * Lwjj entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "lwjj", catalog = "langwen")
public class Lwjj implements java.io.Serializable {
	...
	/** minimal constructor */
	public Lwjj(String biaoti, String xiangxi) {
		this.biaoti = biaoti;
		this.xiangxi = xiangxi;
	}

	/** full constructor */
	public Lwjj(String biaoti, String xiangxi, String faburen,
	...
	public Lwjj(Integer id, String biaoti, String faburen, String fabushijian,
	...
	public String toString() {
		return "Lwjj [id=" + id + ", biaoti=" + biaoti + ", xiangxi=" + xiangxi
