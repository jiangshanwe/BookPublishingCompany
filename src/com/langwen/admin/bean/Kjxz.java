...
/**
 * Kjxz entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "kjxz", catalog = "langwen")
public class Kjxz implements java.io.Serializable {
	...
	/** minimal constructor */
	public Kjxz(String biaoti) {
		this.biaoti = biaoti;
	}

	/** full constructor */
	public Kjxz(String biaoti, String jieshao, String dyts, String fujian,
	...
	public Kjxz(Integer id, String biaoti, String dyts, String fujian,
			String bdfx, String fxmm, String tupian, String tianjiaren,
			String tianjiashijian, String gengxinren, String gengxinshijian,
			Integer paixu) {
		super();
	...
	public String toString() {
		return "Kjxz [id=" + id + ", biaoti=" + biaoti + ", paixu=" + paixu
				+ "]" + "\n";
	}
