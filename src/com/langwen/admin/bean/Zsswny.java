...
/**
 * Zsswny entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "zsswny", catalog = "langwen")
public class Zsswny implements java.io.Serializable {
	...
	/** full constructor */
	public Zsswny(String shuming, String chubanshe, String tupian,
