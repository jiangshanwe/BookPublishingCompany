...
<html>
	<head>
		...
		<title>My JSP 'rczpShowall.jsp' starting page</title>
	...
	<body>
		<form action="rczpTianjia">
			<s:submit value="添加新的人才招聘项目" align="left"></s:submit>
		</form>
		...
		<div>
			<table border="1" align="center">
				...
				<s:iterator value="#session.allRczps" id="als">
					<tr align="center" height="49.6">
						<td width="165">
							<s:property value="#als.biaoti" />
						</td>
						<td width="150" align="center">
							<s:form action="rczpYulan">
						...
						<td width="80">
							<s:form action="rczpBianji">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
								<s:submit value="编辑"></s:submit>
							</s:form>
						</td>
						<td width="80">
							<s:form action="rczpShanchu">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
								<s:submit value="删除" onclick="return confirm('确认删除此条招聘项目？')"></s:submit>
							</s:form>
						</td>
					</tr>
				</s:iterator>
