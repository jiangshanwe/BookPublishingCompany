	...
	<body>
		<form action="hydtUpdate" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<s:hidden name="id" value="%{#session.hydtBianji.id}"></s:hidden>
				<s:hidden name="typelimit" value="1"></s:hidden>
				<p>
					<s:textfield name="biaoti" label="标题"
						value="%{#session.hydtBianji.biaoti}"></s:textfield>
				</p>
				<p>
					<s:textfield name="ywlj" value="%{#session.hydtBianji.ywlj}"
	...
	bkLib.onDomLoaded(function() {
		nicEditors.allTextAreas()
					...
					<textarea name="zhengwen" style="width: 100%; height: 380px;">
							<s:property value="#session.hydtBianji.zhengwen" />
</textarea>
				</div>
				<p>
