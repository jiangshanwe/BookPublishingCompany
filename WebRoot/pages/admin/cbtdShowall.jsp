...
<html>
	<head>
		...
		<title>My JSP 'cbtdShowall.jsp' starting page</title>
	...
	<body>
		<form action="cbtdTianjia">
			<s:submit value="添加新的出版天地项目" align="left"></s:submit>
		</form>
		...
		<div>
			<table border="1" align="center">
				...
				<s:iterator value="#session.allCbtds" id="als">
					<tr align="center" height="49.6">
						<td width="165">
							<s:property value="#als.biaoti" />
						</td>
						<td width="150" align="center">
							<s:form action="cbtdYulan">
						...
						<td width="80">
							<s:form action="cbtdBianji">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
								<s:submit value="编辑"></s:submit>
							</s:form>
						</td>
						<td width="80">
							<s:form action="cbtdShanchu">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
