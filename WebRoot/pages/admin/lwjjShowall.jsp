...
<html>
	<head>
		...
		<title>My JSP 'lwjjShowall.jsp' starting page</title>
	...
	<body>
		<form action="lwjjTianjia">
			<s:submit value="添加新的朗文简介项目" align="left"></s:submit>
		</form>
		...
		<div>
			<table border="1" align="center">
				...
				<s:iterator value="#session.allLwjjs" id="als">
					<tr align="center" height="49.6">
						<td width="165">
							<s:property value="#als.biaoti" />
						</td>
						<td width="150" align="center">
							<s:form action="lwjjYulan">
						...
						<td width="80">
							<s:form action="lwjjBianji">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
								<s:submit value="编辑"></s:submit>
							</s:form>
						</td>
						<td width="80">
							<s:form action="lwjjShanchu">
								<s:hidden value="%{#als.id}" name="id"></s:hidden>
