		...
		<div id="central">
			<div class="central_left">
				...
				<div class="aleft_box">
					<ul>
						<br>
						<s:iterator value="#session.lwjjList" id="ll" status="st">
							...
							<a href="flwjj?id=<s:property value='%{#ll.id}'/>"> <s:property
									value="#ll.biaoti" /> </a>
							</li>
						</s:iterator>
					</ul>
			...
			<div class="central_right">
				<div id="right_messageBox">
					...
					<div class="news_title">
						<p>
							<s:property value="#session.lwjj.biaoti" />
						</p>
					</div>
					<div class="Article_area">
						<p>
							<s:property value="#session.lwjj.xiangxi" escape="false" />
						</p>
					</div>
				</div>
			</div>
