				...
				<div class="pagelist">
					<ul>
						<s:if test="#session.page!=1">
							<li>
								<a href="asearchXiazai?page=1">首页</a>
							</li>

							<li>
								<a href="asearchXiazaiSyy">上页</a>
							</li>
						</s:if>
						<s:if test="#session.page< #session.pageCount">
							<li>
								<a href="asearchXiazaiXyy">下页</a>
							</li>
							<li>
								<a
									href="asearchXiazai?page=<s:property value='%{#session.pageCount}'/>">尾页</a>
							</li>
						</s:if>
						<li class="pageinfo">
							第&nbsp;
