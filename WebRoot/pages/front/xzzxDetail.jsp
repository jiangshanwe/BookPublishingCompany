			...
			<div class="central_right">
				...
				<div id="right_messageBox">
					...
					<div class="news_title">
						<p>
							<s:property value="#session.xzzxDetail.biaoti" />
						</p>
					</div>
					<div class="Article_area" style="line-height: 1.5">
						<p>
							<s:property value="#session.xzzxDetail.jieshao" escape="false" />
						</p>
						<br />
						<p>
							附件：&nbsp;&nbsp;
							<a
								href='fujian/xzzx/<s:property value="%{#session.xzzxDetail.fujian}"/>'><s:property
									value="#session.xzzxDetail.fujian" /> </a>
						</p>
					</div>
				</div>
			</div>
