				...
				<div class="right_title">
					...
					<p style="float: right; padding-right: 12px;">
						<form method="post" action="osearchKejian">
							<input type="text" value="<s:property value='%{#session.okkey}'/>"
								name="okkey"
				...
				<div class="pagelist">
					<ul>
						<s:if test="#session.page!=1">
							<li>
								<a href="osearchKejian?page=1">首页</a>
							</li>

							<li>
								<a href="osearchKejianSyy">上页</a>
							</li>
						</s:if>
						<s:if test="#session.page< #session.pageCount">
							<li>
								<a href="osearchKejianXyy">下页</a>
							</li>
							<li>
								<a
									href="osearchKejian?page=<s:property value='%{#session.pageCount}'/>">尾页</a>
							</li>
						</s:if>
						<li class="pageinfo">
							第&nbsp;
