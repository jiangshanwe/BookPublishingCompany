			...
			<div class="central_right">
				<div class="right_title">
					...
					<p style="float: right; padding-right: 12px;">
						<form method="post" action="osearchKejian">
							<input type="text"
								value="<s:property value='%{#session.okkey}'/>" name="okkey"
							...
							&nbsp;&nbsp;
							<input type="submit" value="搜索课件" class="searchLabel">
						</form>
					</p>
				</div>
				<div id="right_messageBox">
					<ul>
						<s:if test="#session.kjxzList.size==0">
							<p style="margin-left: 83px; margin-top: 46px;">
								暂无课件信息
							</p>
						</s:if>
						<s:iterator value="#session.kjxzList" id="hl">
							<li>
								<a href="fkjxzDetail?id=<s:property value='%{#hl.id}' />"> <s:property
										value="#hl.biaoti" /> </a>
								<p>
				...
				<div class="pagelist">
					<ul>
						<s:if test="#session.page!=1">
							<li>
								<a href="fkjxzList?page=1">首页</a>
							</li>

							<li>
								<a href="fkjxzSyy">上页</a>
							</li>
						</s:if>
						<s:if test="#session.page< #session.pageCount">
							<li>
								<a href="fkjxzXyy">下页</a>
							</li>
							<li>
								<a
									href="fkjxzList?page=<s:property value='%{#session.pageCount}'/>">尾页</a>
							</li>
						</s:if>
						<li class="pageinfo">
							第&nbsp;
