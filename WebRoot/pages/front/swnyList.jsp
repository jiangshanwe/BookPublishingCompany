		...
		<div id="central">
			...
			<div class="central_right">
				...
				<div id="right_messageBook">
					<ul>
						<s:if test="#session.swnyList.size==0">
							<p style="margin-left: 83px; margin-top: 46px;">
								暂无图书信息
							</p>
						</s:if>
						<s:iterator value="#session.swnyList" id="bl" status="st">
							...
							<a href="fswnyDetail?id=<s:property value='%{#bl.id}' />"
								target="_blank"> <img alt="暂无图书照片"
									src='bookPic/swny/<s:property value="%{#bl.tupian1}"/>'>
							</a>
							<p>
								<a href="fswnyDetail?id=<s:property value='%{#bl.id}' />"
				...
				<div class="pagelist">
					<ul>
						<s:if test="#session.page!=1">
							<li>
								<a href="fswnyList?page=1">首页</a>
							</li>

							<li>
								<a href="fswnySyy">上页</a>
							</li>
						</s:if>
						<s:if test="#session.page< #session.pageCount">
							<li>
								<a href="fswnyXyy">下页</a>
							</li>
							<li>
								<a
									href="fswnyList?page=<s:property value='%{#session.pageCount}'/>">尾页</a>
							</li>
						</s:if>
						<li class="pageinfo">
							第&nbsp;
